...
- **draw_my_life_code**: This folder contains all the code required to run the Draw My Life activity.
- **data**: This folder contains the collected data, in anonymized and aggregated form.
